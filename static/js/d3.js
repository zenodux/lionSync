(function() {
  ...
  d3.json = function(url, callback,jsonobj) {
	console.log(d3.xhr(url, "application/json", callback).response(d3_json));
    //return d3.xhr(url, "application/json", callback).response(jsonobj);
	//console.log(url);
	//return url;
  };
