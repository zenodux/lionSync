...
var header = $('<div></div>').addClass('row-fluid').append('<h2>Map of Latrine Coverage</h2>');
var mapContent = $('<div style="height:60%"></div>').addClass('row-fluid');
mapContent.append($('<div class="span6"><div id="mapDiv" style="width:100%;height:100%"></div></div>'));
mapContent.append($('<div id="detailDiv" class="span6"><p style="left:50%;top:50%">Click on a district for more information.</p></div>'));
contentDiv.append(header);
contentDiv.append(mapContent);
